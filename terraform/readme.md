...
- {name: general, server: 97.107.137.98, port: 55409, type: vless, uuid: 290ef730-3d75-4a65-d777-38216ab12fc5, tls: true, reality-opts: {public-key: Z3ZGnAOdKkzJ07gR_7_0k9_iTTFP6paDOrqx1rN2LU4}, servername: swdist.apple.com, client-fingerprint: chrome, network: tcp}


vless://33122894-9c2f-4c2b-8262-4272981129b5@172.104.47.17:443?encryption=none&flow=xtls-rprx-vision&security=reality&sni=swdist.apple.com&fp=chrome&pbk=&sid=8e3f885e&type=tcp&headerType=none#Linode-Xra 转换成
- {name: general, server: 97.107.137.98, port: 55409, type: vless, uuid: 290ef730-3d75-4a65-d777-38216ab12fc5, tls: true, reality-opts: {public-key: Z3ZGnAOdKkzJ07gR_7_0k9_iTTFP6paDOrqx1rN2LU4}, servername: swdist.apple.com, client-fingerprint: chrome, network: tcp}
这种格式


- {name: Linode-Xra, server: 172.104.47.17, port: 443, type: vless, uuid: 33122894-9c2f-4c2b-8262-4272981129b5, tls: true, flow: xtls-rprx-vision, reality-opts: {public-key: "", short-id: 8e3f885e}, servername: swdist.apple.com, client-fingerprint: chrome, network: tcp}
~~~
...
× xray.service - Xray Service
    ...
    Drop-In: /etc/systemd/system/xray.service.d
     ...
     Active: failed (Result: exit-code) since Mon 2026-03-16 10:39:18 UTC; 2min 5s ago
   Duration: 333ms
       Docs: https://github.com/xtls
    Process: 2011 ExecStart=/usr/local/bin/xray run -config /usr/local/etc/xray/config.json (code=exited, status=23)
   Main PID: 2011 (code=exited, status=23)
        CPU: 16ms

Mar 16 10:39:18 localhost systemd[1]: Started xray.service - Xray Service.
Mar 16 10:39:18 localhost xray[2011]: Xray 26.2.6 (Xray, Penetrates Everything.) 12ee51e (go1.25.7 linux/amd64)
Mar 16 10:39:18 localhost xray[2011]: A unified platform for anti-censorship.
Mar 16 10:39:18 localhost xray[2011]: Failed to start: main: failed to load config files: [/usr/local/etc/xray/config.json] > infra/conf: failed to build inbound config with tag  > infra/conf: Failed to build REALITY con>
Mar 16 10:39:18 localhost systemd[1]: xray.service: Main process exited, code=exited, status=23/n/a
Mar 16 10:39:18 localhost systemd[1]: xray.service: Failed with result 'exit-code'.
root@localhost:~# ls /usr/local/etc/xray/config.json
/usr/local/etc/xray/config.json
root@localhost:~# cat /usr/local/etc/xray/config.json
{
  "inbounds": [
    {
      "listen": "0.0.0.0",
      ...
      "settings": {
        "clients": [
          {
            "id": "f30e3167-74b4-447c-b4da-232b3368e572",
